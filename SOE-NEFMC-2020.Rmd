...
gom_landings <- landings %>% filter(EPU == "GOM") %>% 
  ...
  ggtitle("Gulf of Maine landings by guild")
...
gb_landings <- landings %>% filter(EPU == "GB") %>% 
  ...
  theme_facet() +
  theme(strip.text=element_text(hjust=0)) +
  ggtitle("Georges Bank landings by guild")
