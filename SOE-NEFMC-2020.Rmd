...
```{r gom-timesseries-heatwave1, out.width = "50%", fig.cap = "Marine heatwave events in the Gulf of Maine occurring in 2019. Color indicates all heatwaves (orange and red) and strongest heatwave (red).", eval= T, echo = F}
...
```{r gb-timesseries-heatwave, out.width = "50%", fig.cap="Marine heatwave events on Georges Bank occurring in 2019. Color indicates all heatwaves (orange and red) and strongest heatwave (red).", eval= T, echo = F}
