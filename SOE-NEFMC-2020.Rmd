...
```{r gom-timesseries-heatwave1, fig.cap = "Marine heatwave events (red) in the Gulf of Maine occuring in 2019.", eval= T, echo = F}
...
```{r gb-timesseries-heatwave, fig.cap="Marine heatwave events (red) on Georges Bank occuring in 2019.", eval= T, echo = F}
