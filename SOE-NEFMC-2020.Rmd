...
```{r gom-timesseries-heatwave1, out.width = "50%", fig.cap = "Marine heatwave events (red) in the Gulf of Maine occurring in 2019.", eval= T, echo = F}
...
```{r gb-timesseries-heatwave, out.width = "50%", fig.cap="Marine heatwave events (red) on Georges Bank occurring in 2019.", eval= T, echo = F}
