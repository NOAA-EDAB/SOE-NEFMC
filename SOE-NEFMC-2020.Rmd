...
## Gulf Stream Index and Labrador Slope Water interaction 
...
```{r gom-timesseries-heatwave1, out.width = "50%", fig.cap = "Marine heatwave events (red) in the Gulf of Maine occuring in 2019.", eval= T, echo = F}
...
```{r gom-heatwave, eval= T, echo = F, fig.width = 8, fig.asp = .35, fig.cap="Marine heatwave cumulative intesity (left) and maximum intensity (right) in the Gulf of Maine ."}
...
```{r gb-timesseries-heatwave, out.width = "50%", fig.cap="Marine heatwave events (red) on Georges Bank occuring in 2019.", eval= T, echo = F}
...
```{r gb-heatwave, eval= T, echo = F, fig.width = 8, fig.asp = .35, fig.cap="Marine heatwave cumulative intesity (left) and maximum intensity (right) in the Gulf of Maine ."}
# cumu <- ecodata::heatwave %>% 
#   filter(Var == "cumulative intensity") %>% 
#   mutate(Var = recode(Var, "cumulative intensity" = "Cumulative Intensity (degree C x days)"))
# 
