...
\fancyheadinit{%
   \ifthenelse{\value{page}=5}%
      {\fancyhead[R]{\includegraphics[width=40pt]{images/NOAA_logo.png} \\ \textsf{\emph{March 22, 2022}}}
       \fancyhead[L]{\textsf{\LARGE DRAFT - State of the Ecosystem 2023: New England}}
      }%
      {\fancyhead[R]{}
       \fancyhead[L]{\textsf{\emph{DRAFT - State of the Ecosystem 2023: New England}}}
      }
}
