...
```{r stock-status, warning=F, fig.cap = paste0("Summary of single species status for ",council_abbr," and jointly managed stocks."), fig.width = 7.5, fig.asp = 0.5}
...
```{r nefsc-biomass-mab, fig.cap = paste0("Fall (left) and spring (right) surveyed biomass in the Mid-Atlantic Bight. Data from the NEFSC Bottom Trawl Survey are shown in black, with NEAMAP shown in red."), fig.width=8, fig.asp = 0.75}
...
```{r mab-cf, fig.cap = "Condition factor for MAFMC managed species.", out.width = '\\textwidth'}
