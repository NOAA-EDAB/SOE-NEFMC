...
GOM common tern average productivity (fledgelings per nest) across 7 colonies has varied over time but was low in 2018 (Fig. \ref{fig:aggregate-prod}), a year with record-high summer SST in the GOM (Fig. \ref{fig:NE-SST-anom-series}), and substantial butterfish in tern diets (Fig. \ref{fig:map-and-prey}b). 
