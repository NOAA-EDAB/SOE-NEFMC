...
remotes::install_github("noaa-edab/ecodata@0.1.0")
library(ggplot2)
library(dplyr)
library(tidyr)
library(ecodata)
...
```{r NE-stock-status, warning=F, fig.cap = paste0("Summary of single species status for NEFMC and jointly managed stocks. \\label{stock-status}"), fig.width = 8, fig.asp = 0.65}
