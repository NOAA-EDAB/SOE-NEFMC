...
Benthivore biomass catch in both offshore surveys during the fall has declined for the third straight year from 2015 highs, with more subtle recent downward trends in the inshore surveys (Figs \ref{fig:MA-inshore}, \ref{fig:menh-survey}). Change in haddock catch is the largest contributor to these fluctuations. 
...
```{r NE-zoo-abund, fig.width = 8, fig.asp = .5, fig.cap = "Abundance anomaly time series for key zooplankton species found in the GOM and GB."}
