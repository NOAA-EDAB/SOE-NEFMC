...
```{r NE-bot-temp, fig.width = 6, fig.asp = .55, fig.cap = "Annual bottom temperatures in New England."}
...
```{r NE-zoo-abund, fig.width = 8, fig.asp = .35, fig.cap = "Abundance anomaly time series for key zooplankton species found in the GOM and GB."}
