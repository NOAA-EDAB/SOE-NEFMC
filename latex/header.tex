...
\AddEverypageHook{%
   \ifthenelse{\value{page}=3}%
     {\rhead{\includegraphics[width=40pt]{images/NOAA_logo.png} \\ \textsf{\emph{10 April 2020}}}
      \lhead{\textsf{\LARGE State of the Ecosystem 2020: New England}}
      }%
     {\rhead{}
      \lhead{\textsf{\emph{State of the Ecosystem 2020: New England}}}
     }
}
