...
```{r, code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/human_dimensions_NE.Rmd-comdat-total-landings.R")}
```
...
#```{r, code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chun#k-scripts/human_dimensions_NE.Rmd-fogarty.R")}
#```

#```{r, code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chun#k-scripts/human_dimensions_NE.Rmd-ryther.R")}
#```
...
```{r, code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/human_dimensions_NE.Rmd-comdat-comm-revenue.R")}
```

Revenue trends overall mirror those for the benthos (clams and scallops) group over the past decade.  
```{r, code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/human_dimensions_NE.Rmd-bennet2.R"), fig.width = 7.5, fig.asp = 0.5}
```
