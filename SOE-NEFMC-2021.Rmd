...
```{r calanus-stage,  fig.cap= " ", code=readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/LTL_NE.Rmd-gom-calanus-stage.R"), fig.asp = .75}
```
...
As mentioned [above](#), the New England region had multiple marine heatwaves in 2020 (Figs. \ref{heatwave-year-gb} and \ref{heatwave-year-gom}). Both regions experienced higher than average cumulative and maximum intensity which has also occured over the last decade (Fig. \ref{fig:heatwave-intensity}). 2012 is still the warmest year on record in the Northeast US LME. Recent papers published on the impacts of the 2012 heatwave give insight into the implications of marine heatwaves. Lobster was impacted as well as the timing of fishing and markets [@mills_fisheries_2013].  Cobia and other more southern species exhibited habitat shifts, and were seen off Rhode Island.
