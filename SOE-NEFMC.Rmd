...
```{r chl-month, fig.cap="Monthly median chlorophyll a concentration on GB (top, black) and in the GOM (bottom, black) with significant increases in January, October, and December (orange lines) in the GOM.", fig.width =14, fig.height = 8, results='hide'}
#, fig.width = 5,  code=readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/LTL_MAB.Rmd-cold_pool.R")
