...
```{r bottom-temp, fig.cap="Annual Georges Bank and Gulf of Maine seasonal bottom temperature anomalies. Data from the last two years (open circles) are from a near-real-time model and are considered preliminary.", code=readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/LTL_NE.Rmd-seasonal-bt-anom.R"), fig.width=6}
```
