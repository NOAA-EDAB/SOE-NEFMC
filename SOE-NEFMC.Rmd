...
```{r rec-hms, fig.cap = "Recreational shark landings from Marine Recreational Information Program (left) and Large Pelagics Survey (right)", fig.width=10,fig.asp = 0.4}
...
```{r longterm-sst, fig.cap="Mean sea surface temperature in New England.", fig.width = 7.5, fig.asp = .3}
