...
ADD BENTHOS FORAGE HERE?

Benthic invertebrates are extremely important forage for some managed species (flatfish, juvenile cod,...) Macrobenthos indices show long term declines in spring. In contrast, Megabenthos indices show long term increases in spring in the MAB.
...
#c <- ecodata::plot_zooplankton_index(report = "NewEngland", varName = "Euph", n=10) +  ggplot2::theme(legend.position = "none")
...
REPLACE WITH NEW FIGS NEED WRITEUP POSTED
LOWEST ARAGONITE SATURATION OBSERVED SINCE MEASUREMENTS STARTED IN 2007
...
THIS NEEDS AN UPDATE WE DON'T KNOW WHICH COMMUNITIES TO INCLUDE HERE
...
magick::image_read("https://github.com/NOAA-EDAB/ecodata/raw/dev/data-raw/workshop/images/Figure2-GraceSaba_2024.png")
...
# NEW FILE 
magick::image_read("https://github.com/NOAA-EDAB/ecodata/blob/dev/data-raw/workshop/images/2023-GOMbloom-internalreview.png?raw=true")
